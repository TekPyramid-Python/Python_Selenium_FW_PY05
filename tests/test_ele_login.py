...
from pages.elle_login_page import LoginEllePage
from tests.base_test import BaseTest


@allure.feature("Authentication")
@allure.story("User Login")
class TestEleLogin(BaseTest):
    ...
    def test_successful_login(self):
        ...
        login_page_ele = LoginEllePage(self.driver)
        ...
        with allure.step("Navigate to login page"):
            login_page_ele.navigate_to(base_url)
            # The is_visible method is inherited from BasePage
            assert login_page_ele.is_visible(login_page_ele.Logo), "Login page did not load properly"
    #
        with allure.step("Perform login with valid credentials"):
            login_page_ele.login('lavanya','srirama','sriramalavanya98@gmail.com','6303047412','lavanya645678')



        with allure.step("Verify successful login and page title"):
            assert login_page_ele.is_login_successful(), "Login was not successful, inventory page not found."
