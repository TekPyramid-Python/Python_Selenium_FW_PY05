# tests/test_coffee_wishlist_flow.py
import allure
import pytest
...
from pages.coffee_mywishlist_page import MyWishlistPage
...
@allure.story("Wishlist flow")
class TestCoffeeWishlistFlow(BaseTest):
    """
    Test class for login functionality against total.coffee.com.
    """

    @allure.title("Test Wishlisted product moved to wishlist ")
    ...
    def test_search_product(self):
        ...
        wishlist_page = MyWishlistPage(self.driver)
        ...
        with allure.step("clicking the heart icon of product in product list"):
            productlist_page.add_to_wishlist()

        with allure.step("Clicking wishlist icon and reviewing the wishlist"):
             home_page.click_wishlist_icon()

        with allure.step("Clicking the select option for moving to product page"):
            wishlist_page.click_select_option()

        with allure.step("Clicking wishlist icon and reviewing the wishlist"):
            assert product_page.add_to_wishlist_basket(), "Wishlist icon failed to click"
